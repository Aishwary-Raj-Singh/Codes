...
privacy_key = b'MIIEowIBAAKCAQEAzvKDt+EO+A6oE1LItSunkWJ8vN6Tgcu8Ck077joGDfG2NtxD\
...
#key = RSA.export_key(privacy_key)
#byte_string = bytes.fromhex(privacy_key)
flag = b2a_base64(privacy_key)
priv_key = RSA.importKey(flag)
#print key.exportKey()
print(flag)
print(priv_key)
